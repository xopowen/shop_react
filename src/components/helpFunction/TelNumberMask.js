/**
 * @param patter - строчка, которая определяет желаемый шаблон который будит в поле набора номера телефона
 *     пример:"+ 7 (___)-___-__-__".
 * @param replacementChar - > символ, который будит заменятся вводимыми числами.
 * @param ignoreChar - строчка с игнорируемыми символами. При удалении курсор будит перескакивать эти символы
 *      пример:")-".( символа"(" нет так как его перескакивать уже не нужно).
 * @param fields - список полей к которым будут прикреплены слушатели событий focus и input.
 */
class TelNumberMask{
